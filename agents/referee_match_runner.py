...
async def run_match_phases(
    ...
    referee.active_matches[match_id] = {
        "state_machine": state_machine, "context": context
    }
    
    # Phase 1: Invite players
    if not await invite_players(
        referee, context, league_id, round_id, match_id,
    ...
    await notify_game_over(
        referee, league_id, round_id, match_id, winner, drawn_number,
