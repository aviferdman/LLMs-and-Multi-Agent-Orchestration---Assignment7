...
from SHARED.constants import GameStatus, Field, ParityChoice
...
def handle_game_join_ack(message: Dict[str, Any], match_context: MatchContext, logger: LeagueLogger) -> bool:
    ...
    logger.log_message("PLAYER_JOINED", {Field.PLAYER_ID: player_id, Field.MATCH_ID: match_context.match_id})
    return True

def handle_parity_choice(message: Dict[str, Any], match_context: MatchContext, logger: LeagueLogger) -> bool:
