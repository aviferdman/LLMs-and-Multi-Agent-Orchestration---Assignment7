...
async def _send_round_completed(
    round_num: int, results: list, league_config, registered_players, registered_referees, logger
):
    ...
    try:
        ...
        standings_update = build_league_standings_update(
            league_config.league_id, round_num, standings_list
        )
