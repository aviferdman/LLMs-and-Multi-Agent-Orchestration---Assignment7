"""Player message handlers - processes incoming game messages.

This module handles incoming messages from referees including
game invitations, parity calls, and game over notifications.
"""
