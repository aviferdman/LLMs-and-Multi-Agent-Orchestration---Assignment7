...
from SHARED.league_sdk.transport import BaseTransport, HTTPTransport, TransportType, create_transport
...
async def send_with_retry(
    endpoint: str, message: Dict[str, Any],
    max_retries: int = None, timeout: int = None, retry_delay: float = None
