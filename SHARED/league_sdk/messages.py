...
def build_game_over(
    ...
    msg["winner"] = winner
    msg["drawn_number"] = drawn_number
    msg["player_a_choice"] = player_a_choice
    msg["player_b_choice"] = player_b_choice
    return msg
...
def build_match_result_report(
    ...
    msg["player_a"] = player_a
    msg["player_b"] = player_b
    msg["winner"] = winner
    return msg
...
def validate_message(message: Dict[str, Any]) -> bool:
    ...
    if message["protocol"] != "league.v1":
        return False
    
    if not message["timestamp"].endswith("Z"):
        return False
