...
def build_game_invitation(league_id: str, round_id: int, match_id: str, referee_id: str, player_id: str, opponent_id: str) -> Dict[str, Any]:
...
def build_game_join_ack(league_id: str, round_id: int, match_id: str, player_id: str, conversation_id: str) -> Dict[str, Any]:
    """Build GAME_JOIN_ACK message."""
    return create_base_message("GAME_JOIN_ACK", league_id, round_id, match_id, player_id, conversation_id)

def build_choose_parity_call(league_id: str, round_id: int, match_id: str, referee_id: str, player_id: str) -> Dict[str, Any]:
    """Build CHOOSE_PARITY_CALL message."""
    msg = create_base_message("CHOOSE_PARITY_CALL", league_id, round_id, match_id, referee_id)
    msg["player_id"] = player_id
    return msg

def build_parity_choice(league_id: str, round_id: int, match_id: str, player_id: str, choice: str, conversation_id: str) -> Dict[str, Any]:
    """Build PARITY_CHOICE message."""
    msg = create_base_message("PARITY_CHOICE", league_id, round_id, match_id, player_id, conversation_id)
    msg["choice"] = choice
    return msg

def build_game_over(league_id: str, round_id: int, match_id: str, referee_id: str, winner: str, drawn_number: int, player_a_choice: str, player_b_choice: str) -> Dict[str, Any]:
    """Build GAME_OVER message."""
    msg = create_base_message("GAME_OVER", league_id, round_id, match_id, referee_id)
    msg.update({"winner": winner, "drawn_number": drawn_number, "player_a_choice": player_a_choice, "player_b_choice": player_b_choice})
    return msg

def build_match_result_report(league_id: str, round_id: int, match_id: str, referee_id: str, player_a: str, player_b: str, winner: str) -> Dict[str, Any]:
