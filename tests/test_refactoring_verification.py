...
def test_constants_import():
    ...
    from SHARED.constants import (
        MessageType, Port, Endpoint, Field, Status, Timeout,
        AgentID, ParityChoice, Winner, GameStatus, StrategyType,
        LogEvent, Points, PROTOCOL_VERSION, SERVER_HOST
    )
...
def test_player_strategies():
    ...
    from agents.player_strategies import STRATEGIES, RandomStrategy, FrequencyStrategy, PatternStrategy
...
def test_referee_modules():
    ...
    from agents.referee_match_state import MatchStateMachine, MatchContext
