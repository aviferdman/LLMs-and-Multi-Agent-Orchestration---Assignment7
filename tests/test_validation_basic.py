...
from SHARED.league_sdk.validation import validate_message, validate_timestamp, validate_uuid
...
def main():
    ...
    tests = [test_validate_message, test_validate_timestamp, test_validate_uuid]
